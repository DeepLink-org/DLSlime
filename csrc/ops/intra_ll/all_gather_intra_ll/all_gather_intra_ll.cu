...
__global__ __launch_bounds__(1024, 1) void all_to_all_intra_ll_kernel(int8_t*  buffer_ori_ptr,
                                                                      int8_t** ipc_buffer_ptr,
                                                                      int**    ipc_signal_ptr,
                                                                      int32_t  max_bs,
                                                                      int32_t  msg_size,
                                                                      ...
                                                                      int32_t* mask = nullptr)
{
    ...
    const int q_size = max_bs * msg_size * itemsize;
    int8_t* q_ptr = buffer_ori_ptr + q_size * sm_id;
                         ...
                         c10::optional<torch::Tensor> mask)
{
    ...
    int8_t* buffer_ori_ptr = reinterpret_cast<int8_t*>(buffer_ori.data_ptr());
