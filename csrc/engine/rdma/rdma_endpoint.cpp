...
uint8_t RDMAEndpoint::GenerateSENDAssignmentBatch(std::vector<uintptr_t> &ptrs, std::vector<size_t> &data_size, uint32_t batch_size)
{
...
uint8_t RDMAEndpoint::GenerateRECVAssignmentBatch(std::vector<uintptr_t> &ptrs, std::vector<size_t> &data_size, uint32_t batch_size)
{
