...
lhandler = initiator.register_memory_region(
    "buffer",
...
rhandler = initiator.register_remote_memory_region("buffer", target.endpoint_info()["mr_info"]["buffer"])
