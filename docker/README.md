...
```bash
cat >> docker/.env <<'EOF'
DLSLIME_CTRL_IMAGE=ghcr.io/deeplink-org/dlslime-ctrl:0.1.12
...
| Push tag `v0.1.12`         | `0.1.12`, `0.1`, `latest`, `sha-<short>` |
...
The workflow will build `linux/amd64` + `linux/arm64` and push `0.1.12`, `0.1`, `latest`.
