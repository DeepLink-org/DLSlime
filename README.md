...
```
python bench/python/dlslime_torch_dist_sendrecv_bench.py --mode send --use-gpu --iterations 100
```

```
python bench/python/dlslime_torch_dist_sendrecv_bench.py --mode recv --use-gpu --iterations 100
```
...
+========================+===============+===============+==========+
| 1,024                  | 0.059 ms      | 17.21 MB/s    | GPU      |
+------------------------+---------------+---------------+----------+
| 2,048                  | 0.071 ms      | 29.03 MB/s    | GPU      |
+------------------------+---------------+---------------+----------+
| 4,096                  | 0.064 ms      | 64.47 MB/s    | GPU      |
+------------------------+---------------+---------------+----------+
| 8,192                  | 0.063 ms      | 129.44 MB/s   | GPU      |
+------------------------+---------------+---------------+----------+
| 16,384                 | 0.061 ms      | 269.59 MB/s   | GPU      |
+------------------------+---------------+---------------+----------+
| 32,768                 | 0.065 ms      | 507.92 MB/s   | GPU      |
+------------------------+---------------+---------------+----------+
| 65,536                 | 0.060 ms      | 1097.19 MB/s  | GPU      |
+------------------------+---------------+---------------+----------+
| 131,072                | 0.060 ms      | 2193.85 MB/s  | GPU      |
+------------------------+---------------+---------------+----------+
| 262,144                | 0.065 ms      | 4034.76 MB/s  | GPU      |
+------------------------+---------------+---------------+----------+
| 524,288                | 0.077 ms      | 6796.76 MB/s  | GPU      |
+------------------------+---------------+---------------+----------+
| 1,048,576              | 0.093 ms      | 11271.55 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 2,097,152              | 0.127 ms      | 16549.25 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 4,194,304              | 0.165 ms      | 25360.66 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 8,388,608              | 0.287 ms      | 29233.10 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 16,777,216             | 0.531 ms      | 31588.64 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 33,554,432             | 1.166 ms      | 28781.26 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 67,108,864             | 1.972 ms      | 34022.71 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 134,217,728            | 3.400 ms      | 39478.41 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 268,435,456            | 6.330 ms      | 42405.82 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 536,870,912            | 12.216 ms     | 43948.33 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
| 1,073,741,824          | 24.791 ms     | 43311.55 MB/s | GPU      |
+------------------------+---------------+---------------+----------+
